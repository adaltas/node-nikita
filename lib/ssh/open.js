...
module.exports = {
  handler: function(options) {
    ...
    if (this.options.ssh && this.options.ssh.config.host === options.host && this.options.ssh.config.port === options.port && this.options.ssh.config.username === options.username) {
      return;
    }
    this.call({
