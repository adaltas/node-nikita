...
module.exports = {
  handler: function(options) {
    ...
    // Check status
    if (((ref1 = options.store.ssh) != null ? ref1.config : void 0) && options.store.ssh.config.host === options.host && options.store.ssh.config.port === options.port && options.store.ssh.config.username === options.username) {
      return;
    }
