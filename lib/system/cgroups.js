...
module.exports = function(options) {
  ...
  this.system.execute({
    unless: function() {
      return (options.store['nikita:system:type'] != null) && (options.store['nikita:system:release'] != null);
    },
    shy: true,
    ...
    if (/CentOS/.test(line)) {
      if ((base = options.store)['nikita:system:type'] == null) {
        base['nikita:system:type'] = 'centos';
      }
      index = line.split(' ').indexOf('release');
      if ((base1 = options.store)['nikita:system:release'] == null) {
        base1['nikita:system:release'] = line.split(' ')[index + 1];
      }
    }
    if (/Red\sHat/.test(line)) {
      if ((base2 = options.store)['nikita:system:type'] == null) {
        base2['nikita:system:type'] = 'redhat';
      }
      index = line.split(' ').indexOf('release');
      if ((base3 = options.store)['nikita:system:release'] == null) {
        base3['nikita:system:release'] = line.split(' ')[index + 1];
      }
    }
    if (options.store['nikita:system:type'] == null) {
  ...
  this.call({
    ...
    if: function() {
      var ref;
      return (ref = options.store['nikita:system:type']) === 'redhat' || ref === 'centos';
    }
  }, function() {
    return this.system.execute({
      ...
      if (options.store['nikita:cgroups:cpu_path'] == null) {
        if (cpus.length > 0) {
          cpu_path = cpus[0]['path'].split(',')[0];
          if ((base = options.store)['nikita:cgroups:cpu_path'] == null) {
          ...
          switch (options.store['nikita:system:type']) {
            case 'redhat':
              if (options.store['nikita:system:release'][0] === '6') {
                if ((base1 = options.store)['nikita:cgroups:cpu_path'] == null) {
                  base1['nikita:cgroups:cpu_path'] = '/cgroups/cpu';
                }
              }
              if (options.store['nikita:system:release'][0] === '7') {
                if ((base2 = options.store)['nikita:cgroups:cpu_path'] == null) {
                  base2['nikita:cgroups:cpu_path'] = '/sys/fs/cgroup/cpu';
                }
              }
              break;
            default:
              throw Error(`Nikita does not support cgroups on your OS ${options.store['nikita:system:type']}`);
          }
        }
      }
      if (options.store['nikita:cgroups:mount'] == null) {
        if ((base3 = options.store)['nikita:cgroups:mount'] == null) {
          base3['nikita:cgroups:mount'] = `${path.dirname(options.store['nikita:cgroups:cpu_path'])}`;
        }
      }
  ...
  return this.call(function() {
    if (options.store['nikita:system:type'] === 'redhat') {
