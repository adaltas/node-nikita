...
module.exports = function(options) {
  ...
  this.call(function(_, callback) {
    ...
    return fs.stat(ssh, options.source, (err, stats) => {
      if (err) {
        return callback(err);
      }
      if (!err) {
  ...
  this.call(function(_, callback) {
    ...
    return fs.stat(ssh, options.target, (err, stats) => {
      ...
      return glob(ssh, `${options.source}/**`, {
        ...
        fn = (source) => {
          ...
          return this.call(function(_, callback) {
            return fs.stat(ssh, source, (err, source_stats) => {
              var gid, mode, uid;
              uid = options.uid;
              if (options.preserve) {
                if (uid == null) {
  ...
  this.call((_, callback) => {
    // Copy a file
    return misc.file.compare(ssh, [options.source, options.target], function(err, md5) {
      ...
      return misc.file.copyFile(ssh, options.source, options.target, function(err) {
