...
// ## Source Code
var path, string, uid_gid;

module.exports = function(options) {
  var groups_info, modified, ssh, user_info;
  options.log({
  ...
  this.call(function(_, callback) {
    ...
    return uid_gid.passwd(ssh, options.store, function(err, users) {
      if (err) {
        return callback(err);
      }
      options.log({
  ...
  this.call({
    ...
    return uid_gid.group(ssh, options.store, function(err, groups) {
      if (err) {
        return callback(err);
      }
      groups_info = groups;
