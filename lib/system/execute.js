...
module.exports = function(options, callback) {
  ...
  if (options.arch_chroot && !options.chroot_dir) {
    throw Error("Required Option: \"chroot_dir\" with \"arch_chroot\"");
  }
  result = {
    stdout: null,
    stderr: null,
  ...
  this.call({
    ...
    options.cmd = "arch-chroot " + options.chroot_dir + " bash " + options.target;
    return this.file({
      target: "" + (path.join(options.chroot_dir, options.target)),
      content: "" + cmd,
      mode: options.mode,
      shy: true,
      eof: true
