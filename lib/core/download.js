...
module.exports = function(options) {
  ...
  this.call({
    ...
    handler: function(_, callback) {
      ...
      return file.hash(options.ssh, options.destination, algo, (function(_this) {
  ...
  this.call(function(_, callback) {
    return ssh2fs.stat(this.options.ssh, options.destination, function(err, stat) {
  ...
  this.call({
    ...
    handler: function() {
      ...
      this.call(function(_, callback) {
        return file.compare_hash(null, stageDestination, options.ssh, options.destination, algo, function(err, match, hash1, hash2) {
          if (!match) {
            options.log({
  ...
  this.call({
    "if": function() {
      return source_url.protocol === null && !options.ssh;
    },
    handler: function() {
      options.log({
      ...
      this.call(function(_, callback) {
        return file.compare_hash(null, options.source, null, options.destination, algo, function(err, match, hash1, hash2) {
          if (!match) {
            options.log({
              message: "Hash dont match, source is '" + hash1 + "' and destination is '" + hash2 + "'",
              level: 'WARN',
  ...
  this.call({
    ...
    handler: function() {
      ...
      this.call(function(_, callback) {
        return file.compare_hash(null, options.source, options.ssh, options.destination, algo, function(err, match, hash1, hash2) {
          if (!match) {
            options.log({
              message: "Hash dont match, source is '" + hash1 + "' and destination is '" + hash2 + "'",
              level: 'WARN',
      ...
      return this.call({
        ...
        handler: function(_, callback) {
          ...
          options.log({
            message: "Remote destination: '" + stageDestination + "'",
            level: 'INFO',
            module: 'mecano/lib/download'
          });
          rs = fs.createReadStream(options.source);
