...
ceil_limit = function(strInt) {
  if (typeof strInt === 'string') {
    strInt = parseInt(strInt);
  }
  return Math.round(strInt * 0.75);
};
...
module.exports = function(options, callback) {
  ...
  return this.execute({
    ...
    return options.nofile = ceil_limit(stdout.trim(), 65535);
  }).execute({
    ...
    return options.nproc = ceil_limit(stdout.trim());
  }).call(function() {
    var k, len2, ref3;
