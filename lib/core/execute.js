...
module.exports = function(options, callback) {
  var child, stderr, stderr_stream_open, stdout, stdout_stream_open, stds;
  options.log({
  ...
  return child.on("exit", function(code) {
    return setTimeout(function() {
      var err, executed;
      if (stdout_stream_open && !(options.stdout === false || options.stdout === null)) {
        options.log({
          message: null,
          type: 'stdout_stream',
          module: 'mecano/lib/execute'
      ...
      if (!(stderr_stream_open && !(options.stderr === false || options.stderr === null))) {
        options.log({
          message: null,
          type: 'stderr_stream',
          module: 'mecano/lib/execute'
