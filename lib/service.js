...
module.exports = function(options, callback) {
  return wrap(this, arguments, function(options, callback) {
    var chkname, do_action, do_finish, do_install, do_installed, do_started, do_startuped, do_updates, installed, modified, pkgname, srvname, startup_add, startup_del, updates;
    ...
    do_installed = function() {
      ...
      cache = function() {
        ...
        return execute({
          ...
          start = false;
          installed = [];
          for (j = 0, len = stdout.length; j < len; j++) {
            pkg = stdout[j];
