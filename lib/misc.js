...
var ProxyStream, Stream, connect, crypto, each, fs, misc, path, util, _ref;
...
module.exports = misc = {
  ...
  file: {
    ...
    */
    ...
    readFile: function(ssh, path, callback) {
      if (!ssh) {
        return fs.readFile(path, 'ascii', function(err, content) {
    ...
    */
    ...
    writeFile: function(ssh, path, content, callback) {
      if (!ssh) {
