    ...
    */
    ...
    writeFile: function(ssh, path, content, options, callback) {
      ...
      if (!ssh) {
        ...
        passwd = function() {
          if (!(options.username && options.group)) {
            return callback();
          }
          return sftputils.passwd(ssh, function(err, passwd) {
            var gid, uid, _ref1, _ref2, _ref3;
            _ref1 = passwd[options.username], uid = _ref1.uid, gid = _ref1.gid;
            if ((_ref2 = options.uid) == null) {
              options.uid = parseInt(uid);
            }
            if ((_ref3 = options.gid) == null) {
