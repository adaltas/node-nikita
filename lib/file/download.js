...
module.exports = function(options) {
  var algo, protocols_ftp, protocols_http, ref, ref1, ref2, source_hash, source_url, ssh, stageDestination;
  options.log({
  ...
  this.call({ // Accelarator in case we know the target signature
    ...
    handler: function(_, callback) {
      ...
      return file.hash(ssh, options.target, algo, (err, hash) => {
  ...
  this.call(function(_, callback) {
    return ssh2fs.stat(ssh, options.target, function(err, stat) {
  ...
  this.call({
    ...
    handler: function() {
      ...
      this.call({
        if: typeof source_hash === 'string',
        handler: function(_, callback) {
          return file.hash(ssh, stageDestination, algo, (err, hash) => {
            if (source_hash !== hash) {
      ...
      this.call(function(_, callback) {
        return file.compare_hash((options.cache ? null : ssh), stageDestination, ssh, options.target, algo, function(err, match, hash1, hash2) {
          if (!match) {
            options.log({
      ...
      return this.call({
        ...
        handler: function(_, callback) {
          ...
          rs.on('error', function(err) {
            options.log({
              message: `No such source file: ${options.source} (ssh is ${JSON.stringify(!!ssh)})`,
              level: 'ERROR',
              module: 'nikita/lib/file/download'
            });
  ...
  this.call({
    ...
    handler: function() {
      ...
      this.call(function(_, callback) {
        return file.compare_hash(null, options.source, ssh, options.target, algo, function(err, match, hash1, hash2) {
          if (!match) {
            options.log({
              message: `Hash dont match, source is '${hash1}' and target is '${hash2}'`,
              level: 'WARN',
      ...
      return this.call({
        ...
        handler: function(_, callback) {
          ...
          return ssh2fs.writeFile(ssh, stageDestination, rs, function(err) {
            if (err) {
