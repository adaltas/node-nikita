// Generated by CoffeeScript 2.3.1
  ...
  // ## Source Code
var curl, file, fs, misc, path, url,
  indexOf = [].indexOf;
...
module.exports = function({options}) {
  ...
  this.call({ // Accelerator in case we know the target signature
    ...
    return file.hash(ssh, options.target, algo, function(err, hash) {
  ...
  this.call({
    ...
    this.call({
      ...
      return file.hash(ssh, stageDestination, algo, function(err, hash) {
        if (source_hash !== hash) {
    ...
    this.call(function(_, callback) {
      return file.compare_hash((options.cache ? null : ssh), stageDestination, ssh, options.target, algo, (err, match, hash1, hash2) => {
        if (!match) {
          this.log({
  ...
  this.call({
    ...
    this.call(function(_, callback) {
      return file.compare_hash(null, options.source, null, options.target, algo, (err, match, hash1, hash2) => {
        if (!match) {
          this.log({
            message: `Hash dont match, source is '${hash1}' and target is '${hash2}'`,
            level: 'WARN',
  ...
  this.call({
    ...
    this.call(function(_, callback) {
      return file.compare_hash(null, options.source, ssh, options.target, algo, (err, match, hash1, hash2) => {
        if (!match) {
          this.log({
            message: `Hash dont match, source is '${hash1}' and target is '${hash2}'`,
            level: 'WARN',
