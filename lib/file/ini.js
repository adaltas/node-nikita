...
module.exports = function(options) {
  var default_props, org_props, parse, ssh;
  options.log({
  ...
  this.call(function(_, callback) {
    return fs.readFile(ssh, options.target, 'utf8', function(err, data) {
  ...
  this.call({
    ...
    ssh = options.local ? null : ssh;
    return fs.readFile(ssh, options.source, 'utf8', function(err, data) {
      var content;
      if ((err != null ? err.code : void 0) === 'ENOENT') {
        return callback();
      }
