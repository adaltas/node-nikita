...
module.exports = function(options) {
  ...
  this.call({
    handler: function(_, callback) {
      ...
      return file.compare_hash(options.ssh, options.source, null, options.target, algo, (err, match) => {
  ...
  this.call({
    ...
    handler: function(_, callback) {
      return ssh2fs.createReadStream(options.ssh, options.source, (err, rs) => {
        var ws;
        if (err) {
          return callback(err);
        }
