...
module.exports = function() {
  ...
  normalize_arguments = function(_arguments, type) {
    var arg, callback, handler, i, k, l, len1, len2, len3, len4, len5, m, multiple, n, o, options, opts, p, v;
    if (type == null) {
      type = 'call';
    }
    multiple = false;
  ...
  run = function() {
    var action, callback, err, status;
    action = todos.shift();
    if (!action) {
    ...
    return wrap.options(action.options, function(err) {
      ...
      return call_before(action, function(err) {
        ...
        return each(action.options).run(function(options, index, next) {
          var relax;
          relax = function(e) {
            return next(options.relax ? void 0 : e);
          };
