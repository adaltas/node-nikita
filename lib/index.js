...
var EventEmitter, conditions, each, registry, wrap,
  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

module.exports = function() {
  var afters, befores, call_callback, depth, enrich_options, handler, intercept_after, intercept_before, j, jump_to_error, len, listeners, name, normalize_options, obj, option, properties, proto, ref, run, stack, store, todos;
  ...
  normalize_options = function(_arguments, type, enrich) {
    var a, arg, callback, empty, handler, i, k, l, len1, len2, len3, len4, m, n, options, opts, p, ref1, v;
    if (enrich == null) {
      enrich = true;
    }
    empty = false;
  ...
  enrich_options = function(user_options) {
    var _log, emit, global_options, k, local_options, options, parent_options, ref1, v;
    ...
    emit = function(log) {
      var l, len1, listener, ref1, results;
      ref1 = listeners[log.type] != null;
      results = [];
    ...
    return wrap.options(options, function(err) {
      ...
      return intercept_before(options, function(err) {
        ...
        return conditions.all(obj, options, function(err) {
          ...
          var error, status_sync, wait_children;
          for (k in options) {
            v = options[k];
          ...
          try {
            if (options_handler.length === 2) {
              ...
              wait_children = function() {
                if (!todos.length) {
                  return setImmediate(function() {
                    return exec_callback([null, status_sync]);
                  });
                }
