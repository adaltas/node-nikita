...
module.exports = function() {
  ...
  enrich_options = function(user_options) {
    var global_options, k, local_options, log_handler, options, parent_options, v;
    ...
    options.log = function(log) {
      ...
      if (options.log_serializer === true) {
        serialized_log = "[" + log.level + " " + log.time + "]";
        if (log.module) {
          serialized_log += " " + log.module + " - ";
        }
        serialized_log += " " + log.message;
        log = serialized_log;
      } else if (typeof options.log_serializer === 'function') {
