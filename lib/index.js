...
module.exports = function() {
  ...
  normalize_arguments = function(_arguments, type) {
    var arg, callback, found_handler, handler, i, k, l, len1, len2, len3, len4, len5, len6, len7, len8, m, multiple, n, o, options, opts, p, q, r, s, v;
    if (type == null) {
      type = 'call';
    }
    multiple = false;
    ...
    if (handler) {
      for (s = 0, len8 = options.length; s < len8; s++) {
        opts = options[s];
            ...
            try {
              if (handler.length === 2) {
                ...
                wait_children = function() {
                  ...
                  return run(todos.shift(), wait_children);
                };
