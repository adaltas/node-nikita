...
module.exports = function() {
  var call, call_sync, callid, handler, name, obj, properties, proto, run, stack, status, todos;
  ...
  call = function(fn, args, callback) {
    ...
    try {
      ...
      return fn.call.apply(fn, [obj].concat(slice.call(args), [function(err, changed) {
        var e, has_then, i, len, ref, result, todo;
        if (err) {
          has_then = false;
        ...
        if (err) {
          ...
          if (!((ref = args[0]) != null ? ref.shy : void 0)) {
            status.changed = true;
          }
        }
        if (todos.length === 0) {
  ...
  run = function() {
    var changed, err, fn, has_then, i, j, k, len, len1, ref, ref1, ref2, ref3, t, todo, v;
    todo = todos.shift();
    if (!todo) {
