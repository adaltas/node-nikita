...
var EventEmitter, conditions, domain, each, registry, wrap,
  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

module.exports = function() {
  var _run_, afters, befores, call_callback, depth, enrich_options, handle_multiple_call, handler, intercept_after, intercept_before, j, jump_to_error, killed, len, listeners, name, normalize_options, obj, option, properties, proto, ref, ref1, run, stack, store, todos;
