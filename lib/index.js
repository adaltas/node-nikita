...
module.exports = function() {
  ...
  normalize_arguments = function(_arguments, type) {
    var arg, callback, copy, found_handler, handler, i, k, l, len1, len2, len3, len4, len5, len6, len7, len8, m, multiple, n, o, options, opts, p, q, r, s, v;
    if (type == null) {
      type = 'call';
    }
    multiple = false;
  ...
  run = function(action, callback) {
    ...
    if (action.type === 'end') {
      return conditions.all(obj, action.options[0], function(err) {
        if (callback) {
          callback(err);
        }
        return run();
