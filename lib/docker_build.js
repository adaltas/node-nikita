...
module.exports = function(options, callback) {
  var do_construct_command, do_download_dockerfile, do_download_resources, do_provider;
  ...
  do_provider = (function(_this) {
    return function() {
      return docker.get_provider(options, do_construct_command);
    };
  })(this);
  do_construct_command = (function(_this) {
    return function(err, provider) {
      ...
      cmd = options.write != null ? "echo " + options.write + "  | " : '';
