    ...
    return each(options).parallel(goptions.parallel).on('item', function(options, next) {
      ...
      do_get = function() {
        ...
        return execute({
          ...
          var keytab, kvno, line, match, mdate, principal, _, _i, _len, _ref1;
          if (err) {
            return next(err);
          }
          if (!exists) {
          ...
          return execute({
            ...
            if (typeof options.log === "function") {
              options.log("Mecano `krb5_ktadd`: keytab kvno '" + ((_ref2 = keytab[principal]) != null ? _ref2.kvno : void 0) + "', principal kvno '" + kvno + "'");
            }
            if (typeof options.log === "function") {
              options.log("Mecano `krb5_ktadd`: keytab mdate '" + (new Date((_ref3 = keytab[principal]) != null ? _ref3.mdate : void 0)) + "', principal mdate '" + (new Date(mdate)) + "'");
            }
            if (((_ref4 = keytab[principal]) != null ? _ref4.kvno : void 0) === kvno && keytab[principal].mdate === mdate) {
              return do_chown();
            }
            return do_ktremove();
          });
