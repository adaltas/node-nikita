...
module.exports = function(options, callback) {
  var args, cmd, flag, i, len, opt, p, ref, ref1, ref2, ref3, ref4;
  ...
  if (options.name != null) {
    options.log({
      message: "Checking if container already running",
      level: 'INFO',
      module: 'mecano/docker/run'
    });
  }
  ...
  this.call({
    ...
    handler: (function(_this) {
      return function() {
        if (!options.force) {
          throw Error('Use force option if you want to get a new running instance');
        }
