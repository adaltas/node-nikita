  ...
  return wrap(this, arguments, function(options, callback) {
    ...
    if (options.local_cache) {
      ...
      return download({
        ...
        if (options.md5) {
          up_options.md5 = options.md5;
        } else if (options.sha1) {
          up_options.sha1 = options.sha1;
        } else {
          options.md5 = true;
        }
        return upload(up_options, callback);
      });
    } else {
...
download = function(options, callback) {
  var algo, destination, do_checksum, do_download, do_prepare, hash, source, stageDestination, unstage;
  ...
  unstage = function() {
    ...
    md5 = options.md5 ? options.md5 : null;
    return move({
      ssh: options.ssh,
