...
var chmod, chown, copy, diff, each, eco, fs, misc, mkdir, nunjucks, pad, path, quote, string, wrap;

module.exports = function(options, callback) {
  return wrap(arguments, function(options, callback) {
    var append, between, content, destination, destinationHash, destinationStat, do_backup, do_diff, do_end, do_eof, do_ownership, do_permissions, do_read_destination, do_read_source, do_render, do_replace_partial, do_skip_empty_lines, do_write, from, modified, to, w, write, _i, _len, _ref;
    modified = false;
    ...
    do_replace_partial = function() {
      var before, from_index, linebreak, opts, orgContent, pos, posoffset, res, _j, _len1;
      if (!write.length) {
        return do_eof();
      }
      if (typeof options.log === "function") {
      ...
      for (_j = 0, _len1 = write.length; _j < _len1; _j++) {
        ...
        if (opts.match) {
          ...
          if (opts.from && opts.to) {
            ...
            } else if ((from == null) && (to == null) && opts.append) {
              if (typeof options.log === "function") {
