...
module.exports = function() {
  ...
  run = function(options, callback) {
    ...
    return wrap.options(options, function(err) {
      var copy, do_callback, do_conditions, do_handler, do_intercept_after, do_intercept_before, do_once, do_options_after, do_options_before, k, v;
      copy = {};
      for (k in options) {
        v = options[k];
        copy[k] = v;
      ...
      options.attempt = -1;
      do_handler = function() {
        var called, do_next, options_callback, options_handler, status_sync, wait_children;
        options.attempt++;
