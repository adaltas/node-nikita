...
module.exports = function() {
  ...
  if (obj.cascade == null) {
    obj.cascade = obj.options.cascade || {};
  }
  if (obj.store == null) {
    obj.store = {};
  }
  ref = module.exports.cascade;
  // Merge global default cascade
  for (k in ref) {
    v = ref[k];
    if (obj.cascade[k] === void 0) {
      obj.cascade[k] = v;
    }
  }
  // Internal state
  ...
  obj.internal.options = function(_arguments, type, params = {}) {
    var __argument, __arguments, __options, action, args, i, j, l, len, len1, len2, len3, m, middleware, n, newoptions, o, opt, options, opts;
...
// Convert every argument to an array
    ...
    options = (function() {
      ...
      for (p = 0, len4 = options.length; p < len4; p++) {
        ...
        if (params.enrich && ((ref2 = opts.callback) != null ? ref2.length : void 0) > 2) {
          opts.user_args = true;
        }
        if (opts.once === true) {
          opts.once = ['handler'];
  ...
  enrich_options = function(user_options) {
    ...
    for (k in parent_options) {
      v = parent_options[k];
      if (options[k] === void 0 && obj.cascade[k]) {
        options[k] = v;
      }
    }
    ...
    options.log = function(log) {
      var _log, args, file, frame, header, l, len, len1, line, m, method, ref4, stackTrace;
  ...
  state.properties.status = {
    get: function() {
      return function(index) {
        var l, len, len1, m, ref2, ref3, ref4, status, value;
