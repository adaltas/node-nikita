...
module.exports = function() {
  var _run_, afters, befores, call_callback, depth, domain_on_error, enrich_options, handle_multiple_call, headers, index_counter, j, jump_to_error, killed, len, normalize_options, obj, once, option, properties, proto, proxy, ref, ref1, run, stack, store, todos;
    ...
    get: function(target, name) {
      ...
      get_proxy_builder = function() {
        ...
        builder = function() {
          ...
          handler = target.registry.get(proxy.type) || registry.get(proxy.type);
