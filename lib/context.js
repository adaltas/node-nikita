...
var EventEmitter, array, called_deprecate_destination, called_deprecate_local_source, conditions, domain, each, merge, registry, string, todos_create, todos_reset, wrap,
...
module.exports = function() {
  var _run_, afters, befores, call_callback, depth, domain_on_error, enrich_options, handle_multiple_call, headers, index_counter, j, jump_to_error, killed, len, normalize_options, obj, once, option, properties, proxy, ref, ref1, reg, run, stack, store, todos;
  ...
  proxy = new Proxy(obj, {
    ...
    get: function(target, name) {
      ...
      get_proxy_builder = function() {
        var builder;
        builder = function() {
          var args, l, len1, middleware, options, opts, ref2, ref3;
  ...
  normalize_options = function(_arguments, type, enrich) {
    var a, arg, callback, cloned_arg, empty, handler, i, k, l, len1, len2, len3, len4, m, middleware, n, o, options, opts, ref2, v;
    if (enrich == null) {
      enrich = true;
    }
    empty = false;
  ...
  enrich_options = function(user_options) {
    var _logs, global_options, k, log_disabled, options, parent_options, ref2, ref3, v;
    ...
    if ((ref3 = options.log) != null ? ref3._mecano_ : void 0) {
      options.log = [];
    }
    if (options.log == null) {
      options.log = [];
    ...
    if (options.debug) {
      _logs.push(function(log) {
        var msg, ref4, ref5;
        if ((ref4 = log.type) === 'stdout' || ref4 === 'stderr') {
          return;
        }
  ...
  jump_to_error = function(err) {
    var ref2;
    while (todos[0] && ((ref2 = todos[0].type) !== 'catch' && ref2 !== 'then')) {
      todos.shift();
    }
  ...
  run = function(options, callback) {
    var err, header, index, org_options, ref2, ref3, status;
    if (!options) {
      options = todos.shift();
    }
    if (!options) {
    ...
    return wrap.options(options, function(err) {
      var do_callback, do_conditions, do_handler, do_intercept_after, do_intercept_before, do_once, do_options_after, do_options_before;
      do_once = function() {
        var hash, hashme;
      ...
      options.attempt = -1;
      do_handler = function() {
        var called, do_next, k, options_callback, options_handler, opts, ref4, ref5, status_sync, v, wait_children;
        options.attempt++;
        ...
        if (!options.handler) {
          return handle_multiple_call(Error("Unregistered Middleware: " + options.type));
        }
  ...
  properties.each = {
    get: function() {
      return function() {
        var arg, args, key, l, len1, len2, m, options, opts, value;
        args = [].slice.call(arguments);
        arg = args.shift();
