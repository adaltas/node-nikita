...
module.exports = function() {
  var _run_, afters, befores, call_callback, depth, domain_on_error, enrich_options, handle_multiple_call, headers, index_counter, j, jump_to_error, killed, len, normalize_options, obj, once, option, properties, proto, proxy, ref, ref1, run, stack, store, todos, tree;
  ...
  proxy = new Proxy(obj, {
    ...
    get: function(target, name) {
      var full_name, get_proxy_builder;
      if (target[name] != null) {
        return target[name];
      }
      ...
      get_proxy_builder = function() {
        var builder;
        builder = function() {
          var args, handler, l, len1, len2, m, options, opts;
  ...
  run = function(options, callback) {
    ...
    return wrap.options(options, function(err) {
      ...
      do_intercept_before = function() {
        ...
        return each(befores).call(function(before, next) {
          ...
          for (k in before) {
            ...
            if (!(v === options[k] || v === options.full_name)) {
              return next();
            }
          }
          opts = {
      ...
      options.attempt = -1;
      do_handler = function() {
        var called, do_next, k, options_callback, options_handler, opts, status_sync, v, wait_children;
        options.attempt++;
        ...
        if (!options.handler) {
          return handle_multiple_call(Error("Unregistered Handler: " + options.type));
        }
