...
module.exports = function() {
  ...
  normalize_options = function(_arguments, type, enrich = true) {
    var a, arg, callback, cloned_arg, empty, handler, i, j, l, len, len1, len2, m, middleware, options, opts;
    empty = false;
    ...
    // Normalize
    options = (function() {
      var n, ref2, ref3, ref4, results;
      results = [];
      for (i = n = 0, ref2 = options.length; (0 <= ref2 ? n < ref2 : n > ref2); i = 0 <= ref2 ? ++n : --n) {
        ...
        if (enrich && ((ref4 = opts.callback) != null ? ref4.length : void 0) > 2) {
          opts.user_args = true;
        }
        if (opts.once === true) {
          opts.once = ['handler'];
