...
// # Nikita Context
var EventEmitter, array, called_deprecate_destination, called_deprecate_local_source, conditions, domain, each, merge, path, promise, registry, string, todos_create, todos_reset, util, wrap;
...
module.exports = function() {
  ...
  proxy = new Proxy(obj, {
    has: function(target, name) {
      return console.log('proxy has is being called', name);
    },
