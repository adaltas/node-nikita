...
var EventEmitter, array, called_deprecate_destination, called_deprecate_local_source, conditions, domain, each, merge, registry, string, todos_create, todos_reset, util, wrap,
...
module.exports = function() {
  ...
  run = function(options, callback) {
    ...
    return wrap.options(options, function(err) {
      ...
      options.attempt = -1;
      do_handler = function() {
        var called, do_next, k, options_callback, options_handler, options_handler_length, opts, ref4, ref5, status_sync, v, wait_children;
        options.attempt++;
