...
module.exports = iptables = {
  add_properties: ['--protocol', '--source', '---destination', '--jump', '--goto', '--in-interface', '--out-interface', '--fragment', 'tcp|--source-port', 'tcp|--sport', 'tcp|--destination-port', 'tcp|--dport', 'tcp|--tcp-flags', 'tcp|--syn', 'tcp|--tcp-option', 'udp|--source-port', 'udp|--sport', 'udp|--destination-port', 'udp|--dport'],
  ...
  cmd: function(oldrules, newrules) {
    var add_properties, baserule, cmds, create, i, k, new_chains, newrule, old_chains, oldrule, rulenum, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m;
    cmds = [];
    new_chains = [];
