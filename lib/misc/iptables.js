...
module.exports = iptables = {
  ...
  cmd: function(oldrules, newrules) {
    var add_properties, cmds, create, k, newrule, oldrule, v, _i, _j, _len, _len1;
    cmds = [];
  ...
  normalize: function(rules) {
    var k, mk, mv, mvs, newrule, newrules, nk, protocol, rule, v, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
    newrules = [];
