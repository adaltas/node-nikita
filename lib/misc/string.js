...
module.exports = {
  ...
  render: function(options) {
    var base, base1, base2, base3, engine, err, error, filter, func, ref;
    options.log({
    ...
    try {
      switch (options.engine) {
        case 'nunjunks':
          ...
          if ((base3 = options.filters).isEmpty == null) {
            base3.isEmpty = function(obj) {
              if ((obj == null) || obj === '') {
                return true;
              }
          ...
          return options.content = engine.renderString(options.content.toString(), options.context);
        case 'eco':
