...
module.exports = {
  ...
  */
  ...
  render: function(options) {
    var base, base1, base2, base3, base4, e, eco, env, err, filter, func, ref;
    options.log({
      ...
      switch (options.engine) {
        ...
        case 'eco':
          try {
            ...
            e = error;
            throw Error("Uninstalled Package: the optional package \"echo\" is not installed");
          }
