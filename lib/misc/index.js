...
misc = module.exports = {
  array: {
    flatten: function(arr, ret) {
      ...
      for (i = n = 0, ref1 = arr.length; 0 <= ref1 ? n < ref1 : n > ref1; i = 0 <= ref1 ? ++n : --n) {
    ...
    intersect: function(array) {
      var argument, i, item, j, len, len1, n, p, result;
      if (array === null) {
        return [];
      }
      result = [];
      for (i = n = 0, len = array.length; n < len; i = ++n) {
        item = array[i];
        if (result.indexOf(item) !== -1) {
          continue;
        }
        for (j = p = 0, len1 = arguments.length; p < len1; j = ++p) {
    ...
    merge: function() {
      var array, arrays, el, len, len1, n, p, r;
      arrays = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      r = [];
      for (n = 0, len = arrays.length; n < len; n++) {
        array = arrays[n];
  ...
  object: {
    equals: function(obj1, obj2, keys) {
      ...
      for (n = 0, len = keys.length; n < len; n++) {
        k = keys[n];
        if (obj1[k] !== obj2[k]) {
          return false;
        }
  ...
  path: {
    ...
    resolve: function() {
      var callback, locations, n, normalized;
      locations = 2 <= arguments.length ? slice.call(arguments, 0, n = arguments.length - 1) : (n = 0, []), callback = arguments[n++];
      normalized = [];
  ...
  mode: {
    ...
    compare: function() {
      ...
      for (i = n = 1, ref1 = modes.length; 1 <= ref1 ? n < ref1 : n > ref1; i = 1 <= ref1 ? ++n : --n) {
   ...
   */
  merge: function() {
    var clone, copy, from, i, inverse, n, name, options, ref1, ref2, src, target, to;
    target = arguments[0];
    from = 1;
    to = arguments.length;
    ...
    for (i = n = ref1 = from, ref2 = to; ref1 <= ref2 ? n < ref2 : n > ref2; i = ref1 <= ref2 ? ++n : --n) {
  ...
  ini: {
    ...
    *   `comment`   Default to ";"
    ...
    stringify_square_then_curly: function(content, depth, options) {
      var element, i, indent, isArray, isBoolean, isNull, isObj, k, len, n, out, outa, p, prefix, ref1, v;
      if (depth == null) {
        depth = 0;
      }
      if (options == null) {
      ...
      indent = ' ';
      prefix = '';
      for (i = n = 0, ref1 = depth; 0 <= ref1 ? n < ref1 : n > ref1; i = 0 <= ref1 ? ++n : --n) {
        prefix += indent;
      }
      for (k in content) {
        v = content[k];
    ...
    stringify_multi_brackets: function(content, depth, options) {
      var i, indent, isBoolean, isNull, isObj, k, n, out, prefix, ref1, v;
      if (depth == null) {
        depth = 0;
      }
      if (options == null) {
  ...
  cgconfig: {
    ...
    stringify: function(obj, options) {
      var count, group, group_render, i, indent, k, key, len, mount, mount_render, n, name, p, prop, ref1, ref2, ref3, ref4, ref5, render, sections, val, value;
      if (options == null) {
        options = {};
      }
      if (obj.mounts == null) {
      ...
      indent = '';
      for (i = n = 1, ref1 = options.indent; 1 <= ref1 ? n <= ref1 : n >= ref1; i = 1 <= ref1 ? ++n : --n) {
        indent += ' ';
      }
      sections = [];
      if (obj.mounts.length !== 0) {
        mount_render = "mount {\n";
        ref2 = obj.mounts;
        for (k = p = 0, len = ref2.length; p < len; k = ++p) {
          mount = ref2[k];
