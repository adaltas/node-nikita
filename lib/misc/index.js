...
misc = module.exports = {
  ...
  cgconfig: {
    parse: function(str) {
      ...
      lines.forEach(function(line, _, __) {
        var base, base1, controller, match, match_admin, name, name1, name2, name3, name4, sep, type, value;
        if (!line || line.match(/^\s*$/)) {
          return;
        }
        if (!current_mount && !current_group && !current_default) {
          ...
          if (current_mount) {
            if (/^}$/.test(line)) {
              ...
              line = line.split(sep);
              controller = line[0], path = line[1];
              current_mount_section.push({
                type: "" + (controller.trim()),
                path: "" + (path.trim())
              });
            }
          }
    ...
    stringify: function(obj, options) {
      var count, group, group_render, i, indent, k, key, len, m, mount, mount_render, n, name, prop, ref1, ref2, ref3, ref4, ref5, render, sections, type, val, value;
      if (options == null) {
        options = {};
      }
      if (obj.mounts == null) {
      ...
      if (obj.mounts.length !== 0) {
        ...
        for (k = n = 0, len = ref2.length; n < len; k = ++n) {
          mount = ref2[k];
          type = mount.type, path = mount.path;
