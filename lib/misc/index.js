...
misc = module.exports = {
  ...
  path: {
    ...
    resolve: function() {
      var callback, j, locations, normalized;
      locations = 2 <= arguments.length ? slice.call(arguments, 0, j = arguments.length - 1) : (j = 0, []), callback = arguments[j++];
      normalized = [];
