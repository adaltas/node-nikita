...
exports = module.exports = function(args, handler) {
  ...
  _ref = exports.args(args), options = _ref[0], goptions = _ref[1], callback = _ref[2];
...
exports.options = function(options, callback) {
  ...
  return each(options).on('item', function(options, next) {
    var connection, destination, el, i, mode, source, uid_gid, v, _i, _j, _len, _len1, _ref, _ref1;
