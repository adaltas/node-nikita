...
module.exports = {
  ...
  not_if: function(options, skip, succeed) {
    ...
    return module.exports.unless(options, skip, succeed);
  },
  not_if_exec: function(options, skip, succeed) {
    ...
    return module.exports.unless_exec(options, skip, succeed);
  },
  not_if_exists: function(options, skip, succeed) {
    ...
    return module.exports.unless_exists(options, skip, succeed);
  },
