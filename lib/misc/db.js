...
module.exports.cmd = function() {
  ...
  switch (options.engine) {
    case 'mysql':
      ...
      return ["mysql", "-h" + options.host, "-P" + options.port, "-u" + (options.admin_username || options.username), "-p" + (options.admin_password || options.password), options.database ? "-D" + options.database : void 0, options.mysql_options ? "" + options.mysql_options : void 0, options.silent ? "-N -s -r" : void 0, cmd ? "-e \"" + cmd + "\"" : void 0].join(' ');
    case 'postgres':
      if (options.path == null) {
        options.path = 'psql';
      }
