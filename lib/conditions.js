...
module.exports = {
  ...
  */
  ...
  all: function(options, failed, succeed) {
    return each([this["if"], this.if_exists, this.not_if_exists]).on('item', function(next, condition) {
  ...
  */
  ...
  "if": function(options, failed, succeed) {
    ...
    ok = true;
    return each(options["if"]).on('item', function(next, si) {
      if (!ok) {
        return next();
      }
  ...
  */
  ...
  if_exists: function(options, failed, succeed) {
    ...
    return each(options.if_exists).on('item', function(next, if_exists) {
  ...
  */
  ...
  not_if_exists: function(options, failed, succeed) {
    ...
    return each(options.not_if_exists).on('item', function(next, not_if_exists) {
