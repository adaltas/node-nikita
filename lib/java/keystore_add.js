...
module.exports = function(options, callback) {
  ...
  this.upload({
    ...
    if (!err) {
      return options.cacert = tmp_location + "/" + (path.basename(options.cacert));
    }
  });
  this.upload({
    ...
    if (!err) {
      return options.cacert = tmp_location + "/" + (path.basename(options.cert));
    }
  });
  this.upload({
    ...
    if (!err) {
      return options.cacert = tmp_location + "/" + (path.basename(options.key));
    }
  });
  return this.execute({
