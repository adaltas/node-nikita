...
mecano = module.exports = {
  ...
  write: function(goptions, options, callback) {
    ...
    misc.options(options, function(err, options) {
      ...
      written = 0;
      return each(options).parallel(goptions.parallel).on('item', function(options, next) {
        var append, backup, between, content, destination, destinationHash, do_changeOwnership, do_changePermissions, do_end, from, modified, readDestination, readSource, render, replacePartial, to, write, writeContent, _ref1;
        modified = false;
