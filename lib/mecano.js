...
mecano = module.exports = {
  ...
  */
  ...
  /*
    ...
    *   `code_skipped`  Expected code(s) returned by the command if it has no effect, executed will not be incremented, int or array of int, default to 0.   
  ...
  execute: function(options, callback) {
    ...
    return misc.options(options, function(err, options) {
      ...
      return each(options).parallel(true).on('item', function(options, i, next) {
        ...
        if ((_ref2 = options.code_skipped) == null) {
          options.code_skipped = [0];
        }
        ...
        cmd = function() {
          ...
          return run.on("exit", function(code) {
            return setTimeout(function() {
              ...
              console.log(options.code_skipped, code, options.code_skipped.indexOf(code));
