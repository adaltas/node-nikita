...
mecano = module.exports = {
  ...
  ldap_schema: function(goptions, options, callback) {
    ...
    misc.options(options, function(err, options) {
      ...
      modified = 0;
      return each(options).parallel(goptions.parallel).on('item', function(options, next) {
        var binddn, clean, conf, configure, dir, generate, ldif, passwd, register, registered, rename, schema, tempdir, uri, write;
        if (!options.name) {
  ...
  write: function(goptions, options, callback) {
    ...
    misc.options(options, function(err, options) {
      ...
      written = 0;
      return each(options).parallel(goptions.parallel).on('item', function(options, next) {
        var append, between, content, destination, destinationHash, do_backup, do_diff, do_end, do_ownership, do_permissions, do_read_destination, do_read_source, do_render, do_replace_partial, do_write, from, modified, to, write, _ref1;
        modified = false;
