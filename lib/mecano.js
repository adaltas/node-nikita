...
var EventEmitter, Ftp, child, conditions, each, eco, exec, fs, ini, mecano, misc, path, request, url, util;
  ...
  */
  ...
  download: function(options, callback) {
    ...
    return misc.options(options, function(err, options) {
      ...
      downloaded = 0;
      return each(options).on('item', function(options, next) {
        var checksum, destination, download, md5sum, prepare, source, stageDestination, unstage, _ref;
        ...
        prepare = function() {
          return misc.file.exists(options.ssh, destination, function(err, exists) {
            if (exists && !options.force) {
              ...
              return misc.file.hash(destination, 'md5', function(err, hash) {
                if (hash === md5sum) {
                  return next();
                }
        ...
        download = function() {
          var cmd, ftp, pass, rs, u, user, ws, _ref1, _ref2, _ref3, _ref4, _ref5;
        ...
        checksum = function() {
          ...
          return misc.file.hash(stageDestination, 'md5', function(err, hash) {
            if (hash === md5sum) {
              return unstage();
            }
  ...
  */
  ...
  write: function(options, callback) {
    ...
    misc.options(options, function(err, options) {
      ...
      written = 0;
      return each(options).on('item', function(options, next) {
        var append, backup, content, destination, destinationHash, extractPartial, from, fullContent, readDestination, readSource, render, replacePartial, to, writeContent;
        ...
        readSource = function() {
          ...
          return misc.file.exists(ssh, options.source, function(err, exists) {
            ...
            return misc.file.readFile(ssh, options.source, 'utf8', function(err, src) {
              if (err) {
                return next(err);
              }
              content = src;
        ...
        replacePartial = function() {
          ...
          if (options.match) {
            if (options.match instanceof RegExp) {
              ...
              if (append && typeof options.replace === 'string') {
                ...
                if (options.match.test(fullContent)) {
                  ...
                  posoffset = 0;
                  while ((res = append.exec(fullContent)) !== null) {
