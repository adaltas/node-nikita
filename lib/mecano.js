...
mecano = module.exports = {
  ...
  iptables: function(goptions, options, callback) {
    var finish, result, _ref;
    _ref = misc.args(arguments), goptions = _ref[0], options = _ref[1], callback = _ref[2];
    result = child(mecano);
    finish = function(err, written) {
  ...
  user: function(goptions, options, callback) {
    var finish, result, _ref;
    _ref = misc.args(arguments, {
      parallel: true
    }), goptions = _ref[0], options = _ref[1], callback = _ref[2];
    ...
    misc.options(options, function(err, options) {
      ...
      return each(options).parallel(goptions.parallel).on('item', function(options, next) {
        ...
        if (!options.username) {
          return next(new Error("Option 'username' is required"));
        }
        ...
        do_create = function() {
          ...
          if (options.comment) {
            cmd += " -c " + (JSON.stringify(options.comment));
          }
          if (options.uid) {
            cmd += " -u " + options.uid;
          }
