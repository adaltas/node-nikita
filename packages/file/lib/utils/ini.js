...
module.exports = {
  ...
  *   `comment`   Default to ";"
  ...
  stringify: function(obj, section, options = {}) {
    ...
    const safe = module.exports.safe;
    const split_by_dots = module.exports.split_by_dots;
    const children = [];
    let out = "";
    ...
    children.forEach(function(k) {
      ...
      const child = module.exports.stringify(obj[k], (section ? section + "." : "") + nk, options);
  ...
  stringify_single_key: function(obj, section, options = {}) {
    ...
    children.forEach(function(k) {
      ...
      const child = module.exports.stringify_single_key(obj[k], (section ? section + "." : "") + nk, options);
      if (out.length && child.length) {
        out += options.eol;
      }
      return out += child;
