...
// # Nikita Session
var EventEmitter, array, conditions, each, make_action, mixme, path, promise, registry, state_create_level, state_reset_level, string, util;

module.exports = function() {
  var args_to_action, call_callback, handle_get, handle_multiple_call, jump_to_error, obj, proxy, reg, run, run_next, state;
  ...
  args_to_action = function(_arguments, action_name) {
