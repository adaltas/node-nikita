...
var contextualize, each, merge, normalize, plugandplay, registry, session, utils;
...
session = function(args, options = {}) {
  ...
  on_call = function(...args) {
    ...
    prom = action.scheduler.call(async function() {
...
// Merge the registry action with the user action properties
    ...
    pump = output.catch(function(err) {
