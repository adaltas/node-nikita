...
on_options = function({options}) {
  ...
  if (typeof options.backup_mode === 'string') {
    options.backup_mode = parseInt(options.backup_mode, 8);
  }
  if (typeof options.mode === 'string') {
    return options.mode = parseInt(options.mode, 8);
  }
};
...
with content.`
    ...
    'target': {
      type: 'string',
      description: `File path where to write content to.`
    },
    'to': {
      oneOf: [
        {
...
handler = function({options}) {
  ...
  if (typeof options.content === 'function') {
    ...
    options.content = options.content.call(this, context);
  }
  ...
  // Start work
  this.call(function({}, callback) { // read source
    var source;
  ...
  targetStats = null;
  this.call(function({}, callback) { // read target
  ...
  this.call(function({}, callback) { // diff
    var raw, text;
  ...
  this.call(function({}, callback) { // file
    if (!this.status()) {
      return callback();
    }
    if (typeof options.target === 'function') {
