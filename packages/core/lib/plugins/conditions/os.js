    ...
    return await session(
      ...
      async function () {
        ...
        match = action.conditions.if_os.some(function (condition) {
          const a =
            !condition.arch.length ||
            condition.arch.some(function (value) {
          ...
          const n =
            !condition.distribution.length ||
            condition.distribution.some(function (value) {
          ...
          const v =
            !version.length ||
            !condition.version.length ||
            condition.version.some(function (value) {
              version = utils.semver.sanitize(version, "0");
              if (
                typeof value === "string" &&
                utils.semver.satisfies(version, value)
              ) {
                return true;
              }
          ...
          const lv =
            !condition.linux_version.length ||
            condition.linux_version.some(function (value) {
              linux_version = utils.semver.sanitize(linux_version, "0");
              if (
                typeof value === "string" &&
                utils.semver.satisfies(linux_version, value)
              ) {
                return true;
              }
    ...
    "nikita:normalize": {
      ...
      handler: function (action, handler) {
        return async function () {
          ...
          for (const config of [
            action.conditions.if_os,
            action.conditions.unless_os,
          ]) {
            if (!config) {
              continue;
            }
            for (const condition of config) {
              ...
              condition.linux_version = utils.semver.sanitize(
                condition.linux_version,
                "x",
              );
            }
