...
describe 'log.cli', ->
  ...
  describe 'end event', ->
    ...
    they.skip 'with status false', ({ssh}) ->
      # TODO: status is hardcoded for now
      data = []
      nikita()
      .call ({}, next)->
        nikita
