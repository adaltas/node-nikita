...
var contextualize, error, merge, normalize, plugins, registry, run, schedule, session, utils;
...
// Merge the registry action with the user action properties
    ...
    output = action.plugins.hook({
      ...
      handler: function(action) {
        var on_children, ref1, ref2;
        if ((ref1 = action.sibling) != null ? ref1.error : void 0) {
          // Stop executing when sibling or one of its child failed
          throw action.sibling.error;
        }
        on_children = function(children) {
          var child, i, len, results;
          results = [];
          for (i = 0, len = children.length; i < len; i++) {
            child = children[i];
            if (child.children != null) {
              on_children(child.children);
            }
            if (child.error) {
              throw child.error;
            } else {
        ...
        if ((ref2 = action.sibling) != null ? ref2.children : void 0) {
          on_children(action.sibling.children);
        }
