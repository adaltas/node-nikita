...
describe 'conditions', ->
  ...
  describe 'not_if_exists', ->
    ...
    they 'should succeed if not present', (ssh, next) ->
      conditions.not_if_exists(
        ssh: ssh        
        () -> should.be.ok false
        next
      )
    they 'should skip if dir exists', (ssh, next) ->
      conditions.not_if_exists(
        ssh: ssh
    ...
    they 'should succeed if dir does not exists', (ssh, next) ->
      conditions.not_if_exists(
        ssh: ssh
        not_if_exists: './oh_no'
        () -> should.be.ok false
    ...
    they 'should succeed if no file exists', (ssh, next) ->
      conditions.not_if_exists(
        ssh: ssh
